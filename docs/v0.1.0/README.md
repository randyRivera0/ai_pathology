...
Research and educational prototype for classifying HISTOPANTUM colorectal
histopathology images. The milestone demo performs binary classification of
benign colon tissue and colon adenocarcinoma with the final group-aware
Experiment 9 ResNet50 model.
...
Place the verified primary artifact at
`experiments/exp-9/resnet50_final.keras`, or point to it with an environment
variable:

```powershell
$env:AI_PATHOLOGY_RESNET50_MODEL_PATH = "C:\path\to\resnet50_final.keras"
```
